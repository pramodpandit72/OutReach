...
<div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Sign in to your OutReach account</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 shadow-xl shadow-gray-200/50 dark:shadow-none">
            ...
            <form method="POST" action="{{ route('login.submit') }}" id="login-form">
                ...
                <div class="space-y-5">
                    ...
                    <button type="submit" id="login-submit-btn" class="w-full px-6 py-3.5 rounded-xl text-base font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-all hover:-translate-y-0.5">
                        Sign In
                    </button>
                </div>
            </form>
